...
import { CheckSquare, Layers, Upload, MessageSquare, Eye, TrendingUp, Clock, CheckCircle, BarChart3, Briefcase, FileText, User, Calendar, Edit } from 'lucide-react';
...
export function ClientDashboard({ activeView, onViewChange }: ClientDashboardProps) {
        ...
        <div className="border-b border-gray-200">
          <nav className="flex space-x-8">
            {[
              ...
              { id: 'brochure', label: 'Brochure Design', icon: Edit },
  ...
  return (
    <div className="p-6">
      ...
      {activeView === 'brochure-design' && <BrochureDesign />}
